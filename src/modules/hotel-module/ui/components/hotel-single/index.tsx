      ...
      <div className={light.hotelInfo}>
        <div className={light.infoHeader}>
          <div className={light.headerContainer}>
            <span className={light.headerTitle}>BEST WESTERN COLUMBUS HOTEL</span>
        ...
        <div className={light.infoFooter}>
          ...
          <div className={light.footerSummary}>
            <span className={light.summaryTitle}>21 hight, 1 adult</span>
            <span className={light.summaryPrice}>500$</span>
            <button type="button" className={light.summaryButton}>
              <span className={light.buttonTitle}>See availability</span>
            </button>
          </div>
        </div>
      </div>
